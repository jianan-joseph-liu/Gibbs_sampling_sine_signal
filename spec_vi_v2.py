...
class SpecVI:
    ...
    def runModel(self, N_delta=30, N_theta=30, lr_map=5e-4, ntrain_map=5e3, inference_size=500, 
        ...
        random_index = np.random.randint(0, inference_size)
        
        psd_sample = spectral_density_all[random_index]

     
    
        self.spec_mat = psd_sample
        
        return self.spec_mat, Spec_hs, spectral_density_all
